 			...
 			<div class="row">
 				...
 				<div class="col-lg-6">
 					<div class="login_form_inner">
 						<h3>Add you'r item</h3>



						<form class="row login_form" action="functionsforadditem.php" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<p class='field'>
									<label for='user'></label>
									<input type="text" class="form-control" id='user' placeholder="Product name" name='product_name' title='product_name' required/>
							...
							<div class="col-md-12 form-group">
								<p class='field'>
									...
									<input type="text" class="form-control" id='pass' placeholder="Price" name='price' title='price' required />
						...
						<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input  type="submit" value="submit" class="primary-btn" name="functionsforadditem">
							</div>
						</form>
...
<body>
    ...
    <form class="row login_form" action="functionsforadditem.php" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
      ...
      <div class="col-md-12 form-group">
        <input type="submit" name="functionsforadditem">
