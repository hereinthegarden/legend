			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="functions.php" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<p class='field'>
									<label for='user'></label>
									<input type="text" class="form-control" id='user' placeholder="Username" name='username' title='Username' required/>
							...
							<div class="col-md-12 form-group">
								<p class='field'>
									...
									<input type="password" class="form-control" id='pass' placeholder="Password" name='password' title='Password' required />
